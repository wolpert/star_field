            ...
            parent
                ...
                .with_children(|parent| {
                    ...
                    parent
                        ...
                        .with_children(|parent| {
                            let icon = asset_server.load("textures/game_icon/right.png");
                    ...
                    parent
                        ...
                        .with_children(|parent| {
                            let icon = asset_server.load("textures/game_icon/wrench.png");
                            parent.spawn(ImageBundle {
                                style: button_icon_style.clone(),
                                image: UiImage::new(icon),
                                ..default()
                    ...
                    parent
                        ...
                        .with_children(|parent| {
                            let icon = asset_server.load("textures/game_icon/exitRight.png");
                            parent.spawn(ImageBundle {
